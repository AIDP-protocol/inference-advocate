...
- ARCHITECTURE.md mapping every module to its paper section and step, so the code and the paper stay in register with each other

### Phase 1: The pipe (steps 1, 3, 6)
...
### Phase 2: The monitor and the ledger (steps 7, 8, 9)
...
### Phase 3: Delivery Policy (steps 2, 10, 11)
